...
router.get('/documento/:id_pago', (req, res) => {
    ...
    db.query(query, [idPago], (err, rows) => {
        ...
        return res.status(200).send({
            ...
            banco_pago: base.banco_pago || evidenciaCabecera?.banco_pago || evidenciaEmitidaCabecera?.banco_pago || null,
            fecha_operacion: base.fecha_operacion || evidenciaCabecera?.fecha_operacion || evidenciaEmitidaCabecera?.fecha_operacion || null,
            boleta_referencia: base.boleta_referencia || evidenciaCabecera?.boleta_referencia || evidenciaEmitidaCabecera?.boleta_referencia || null,
